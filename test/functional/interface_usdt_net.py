...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/mytherra/mytherra/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(MytherraTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our mytherrad node")
