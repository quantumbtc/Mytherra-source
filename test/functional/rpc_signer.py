...
Verify that a mytherrad node can use an external signer command.
...
class RPCSignerTest(MytherraTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart mytherrad with -signer=<cmd>',
