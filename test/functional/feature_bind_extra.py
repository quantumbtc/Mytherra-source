...
"""
Test starting mytherrad with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(MytherraTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that mytherrad has bound on "::1" (for RPC) and "::" (for P2P).
