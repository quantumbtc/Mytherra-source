...
class TransactionTimeRescanTest(MytherraTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine MYT and create transactions
        ...
        # generate some myt to create transactions and check blockcount
        ...
        # send 10 myt to user's first watch-only address
        self.log.info('Send 10 myt to user')
        ...
        # send 5 myt to our second watch-only address
        self.log.info('Send 5 myt to user')
        ...
        # send 1 myt to our third watch-only address
        self.log.info('Send 1 myt to user')
