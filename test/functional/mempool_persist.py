...
By default, mytherrad will dump mempool on shutdown and
...
class MempoolPersistTest(MytherraTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent mytherrad from writing mempool.dat to disk. Verify that `savemempool` fails")
