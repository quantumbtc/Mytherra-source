...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MytherraTestFramework
    pass


class ExampleTest(MytherraTestFramework):
    # Each functional test is a subclass of the MytherraTestFramework class.
    ...
    def custom_method(self):
        ...
        MytherraTestFramework class so other tests can use it."""
