...
class TxnMallTest(MytherraTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 MYT:
        ...
        # First: use raw transaction API to send 1240 MYT to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 MYT coin each
        ...
        # Node0's balance should be starting balance, plus 50MYT for another
        ...
        # Node0's total balance should be starting balance, plus 100MYT for
