...
"""Verify that starting mytherra with -h works as expected."""

from test_framework.test_framework import MytherraTestFramework
from test_framework.util import assert_equal

class HelpTest(MytherraTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mytherra with -h for help text")
        ...
        self.log.info("Start mytherra with -version for version information")
        ...
        self.log.info("Start mytherrad with -fakearg to make sure it does not start")
