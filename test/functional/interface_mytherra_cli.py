...
# The block reward of coinbaseoutput.nValue (50) MYT/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 MYT/block.
...
class TestMytherraCli(MytherraTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `mytherra-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and mytherra-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and mytherra-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (MYT/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (MYT/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 MYT) to the default wallet.
            ...
            # Test mytherra-cli -generate with -rpcwallet in multiwallet mode.
