...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef MYTHERRA_CHAINPARAMSSEEDS_H\n')
    g.write('#define MYTHERRA_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the mytherra network\n')
    ...
    g.write('#endif // MYTHERRA_CHAINPARAMSSEEDS_H\n')
