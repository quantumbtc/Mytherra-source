...
complete --command mytherra-qt --no-files

# Extract options
function __fish_mytherraqt_get_options
...
complete \
    --command mytherra-qt \
    --arguments "(__fish_mytherraqt_get_options --nofiles)"
