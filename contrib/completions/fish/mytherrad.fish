...
complete --command mytherrad --no-files

# Extract options
function __fish_mytherrad_get_options
...
complete \
    --command mytherrad \
    --arguments "(__fish_mytherrad_get_options --nofiles)"
