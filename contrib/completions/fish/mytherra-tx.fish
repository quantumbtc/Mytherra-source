...
# Extract options
function __fish_mytherra_tx_get_options
...
# Extract commands
function __fish_mytherra_tx_get_commands
...
complete \
    --command mytherra-tx \
    --condition "not __fish_mytherra_seen_cmd (__fish_mytherra_tx_get_commands --commandsonly)" \
    --arguments "(__fish_mytherra_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command mytherra-tx \
    --arguments "(__fish_mytherra_tx_get_commands)" \
    --no-files
