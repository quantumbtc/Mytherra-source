...
"""Example logging Mytherra Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/mytherrad
...
def main(mytherrad_path):
    ...
    b = BPF(text=program, usdt_contexts=[mytherrad_with_usdts])
