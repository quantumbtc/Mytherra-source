Mytherra Core version 0.10.4 is now available from:

  <https://mytherra.org/bin/mytherra-core-0.10.4/>
...
- #6953 `43c2789` Split mytherra-tx into its own package
- #6953 `dfe0d4d` Include mytherra-tx binary on Debian/Ubuntu
