Mytherra version 0.5.4 is now available for download at:
http://sourceforge.net/projects/mytherra/files/Mytherra/mytherra-0.5.4/
...
http://gitorious.org/mytherra/mytherrad-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Mytherra-Qt notifications under Growl 1.3.
Increase required age of Mytherra-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMytherra properly when installing Mytherra-Qt over it. (Windows)
