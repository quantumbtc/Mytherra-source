Mytherra-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/mytherra/files/Mytherra/mytherra-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Mytherra
...
New/changed settings (command-line or mytherra.conf file)
--------------------------------------------------------
