Mytherra Core version 0.13.2 is now available from:

  <https://mytherra.org/bin/mytherra-core-0.13.2/>
...
- #8908 `4a974b2` Update mytherra-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow mytherra-tx to create v2 transactions (mytdrak)
