Mytherra Core version 0.9.2.1 is now available from:

  https://mytherra.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 MYT to 0.01 MYT
...
- Fix "Start mytherra on system login"
