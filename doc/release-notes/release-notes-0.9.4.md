Mytherra Core version 0.9.4 is now available from:

  https://mytherra.org/bin/0.9.4/
...
this update is incompatible with the Mytherra system and could lead to consensus
forks.

Mytherra Core released binaries from https://mytherra.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~mytherra/+archive/ubuntu/mytherra
- A third-party or self-compiled Mytherra Core

upgrade to Mytherra Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
