...
This document provides guidelines for internationalization of the Mytherra Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `mytherra_en.ts` remains unchanged.
