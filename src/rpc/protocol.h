...
#ifndef MYTHERRA_RPC_PROTOCOL_H
#define MYTHERRA_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in mytherrad
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Mytherra is not connected
