...
#ifndef MYTHERRA_WALLET_WALLETUTIL_H
#define MYTHERRA_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! mytherra from opening the wallet, thinking it was newly created, and
...
#endif // MYTHERRA_WALLET_WALLETUTIL_H
