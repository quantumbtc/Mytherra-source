...
#ifndef MYTHERRA_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define MYTHERRA_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // MYTHERRA_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
