...
#ifndef MYTHERRA_WALLET_TRANSACTION_H
#define MYTHERRA_WALLET_TRANSACTION_H
...
public:
     ...
     * on this mytherra node, and set to 0 for transactions that were created
...
#endif // MYTHERRA_WALLET_TRANSACTION_H
