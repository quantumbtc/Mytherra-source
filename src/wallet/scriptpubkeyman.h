...
#ifndef MYTHERRA_WALLET_SCRIPTPUBKEYMAN_H
#define MYTHERRA_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Mytherra Core wallet was originally a collection of unrelated private
...
#endif // MYTHERRA_WALLET_SCRIPTPUBKEYMAN_H
