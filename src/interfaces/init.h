...
#ifndef MYTHERRA_INTERFACES_INIT_H
#define MYTHERRA_INTERFACES_INIT_H
...
//! (mytherra-gui, mytherra-node, mytherra-wallet, mytherrad, mytherra-qt) and each
...
#endif // MYTHERRA_INTERFACES_INIT_H
