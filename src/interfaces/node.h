...
#ifndef MYTHERRA_INTERFACES_NODE_H
#define MYTHERRA_INTERFACES_NODE_H
...
//! Top-level interface for a mytherra node (mytherrad process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or mytherra.conf.
...
#endif // MYTHERRA_INTERFACES_NODE_H
