...
#ifndef MYTHERRA_QT_GUIUTIL_H
#define MYTHERRA_QT_GUIUTIL_H
...
/** Utility functions used by the Mytherra Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "mytherra:" URI into recipient object, return true on successful parsing
