...
{
    // Test regression https://github.com/mytherra/mytherra/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/mytherra-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/mytherra-core/gui/pull/568.
    // With fListen=false in ~/.config/Mytherra/Mytherra-Qt.conf and all else left as default,
    // mytherra-qt should set both -listen and -listenonion to false and start successfully.
