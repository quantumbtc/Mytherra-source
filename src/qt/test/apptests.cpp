...
//! Entry point for MytherraApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &MytherraApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for MytherraGUI tests.
void AppTests::guiTests(MytherraGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &MytherraGUI::consoleShown, this, &AppTests::consoleTests);
