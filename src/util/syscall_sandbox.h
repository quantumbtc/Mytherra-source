...
#ifndef MYTHERRA_UTIL_SYSCALL_SANDBOX_H
#define MYTHERRA_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during mytherrad initialization if Mytherra Core was compiled
...
#endif // MYTHERRA_UTIL_SYSCALL_SANDBOX_H
