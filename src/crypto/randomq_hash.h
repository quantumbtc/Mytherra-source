...
#ifndef MYTHERRA_CRYPTO_RANDOMQ_HASH_H
#define MYTHERRA_CRYPTO_RANDOMQ_HASH_H
...
/** A hasher class for Mytherra's RandomQ hash (SHA256->RandomQ->SHA256). */
class CRandomQHash {
private:
...
#endif // MYTHERRA_CRYPTO_RANDOMQ_HASH_H
