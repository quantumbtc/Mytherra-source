...
#ifndef MYTHERRA_CRYPTO_CHACHA_POLY_AEAD_H
#define MYTHERRA_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@mytherra.
 *
 ...
 *
 * The chacha20-poly1305@mytherra combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@mytherra cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@mytherra are relatively fast in
...
#endif // MYTHERRA_CRYPTO_CHACHA_POLY_AEAD_H
