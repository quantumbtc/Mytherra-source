...
#ifndef MYTHERRA_SCRIPT_STANDARD_H
#define MYTHERRA_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a mytherra address
 */
...
/**
 * Generate a Mytherra scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // MYTHERRA_SCRIPT_STANDARD_H
