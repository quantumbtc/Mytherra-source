...
#ifndef MYTHERRA_ARITH_UINT256_H
#define MYTHERRA_ARITH_UINT256_H
...
public:
     ...
     *
     * Mytherra only uses this "compact" format for encoding difficulty
...
#endif // MYTHERRA_ARITH_UINT256_H
