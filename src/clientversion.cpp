 ...
 * for both mytherrad and mytherra-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Mytherra");
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/mytherra/bips/blob/master/bip-0014.mediawiki)
 */
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/mytherra/mytherra>";
