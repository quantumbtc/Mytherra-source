...
#ifndef MYTHERRA_TEST_SCRIPTNUM10_H
#define MYTHERRA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Mytherra Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // MYTHERRA_TEST_SCRIPTNUM10_H
