...
{
    BOOST_CHECK(TestSplitHost("www.mytherracore.org", "www.mytherracore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.mytherracore.org]", "www.mytherracore.org", 0));
    BOOST_CHECK(TestSplitHost("www.mytherracore.org:80", "www.mytherracore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.mytherracore.org]:80", "www.mytherracore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:24156", "127.0.0.1", 24156));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:24156", "127.0.0.1", 24156));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:24156", "::ffff:127.0.0.1", 24156));
    BOOST_CHECK(TestSplitHost("[::]:24156", "::", 24156));
    BOOST_CHECK(TestSplitHost("::24156", "::24156", 0));
    BOOST_CHECK(TestSplitHost(":24156", "", 24156));
    BOOST_CHECK(TestSplitHost("[]:24156", "", 24156));
    ...
    BOOST_CHECK(TestSplitHost("www.mytherracore.org:65536", "www.mytherracore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.mytherracore.org:0", "www.mytherracore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.mytherracore.org:", "www.mytherracore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:24156", "127.0.0.1:24156"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:24156", "[::]:24156"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
