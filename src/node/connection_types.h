...
#ifndef MYTHERRA_NODE_CONNECTION_TYPES_H
#define MYTHERRA_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/mytherra-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Mytherra’s Peer-to-Peer Network")
...
#endif // MYTHERRA_NODE_CONNECTION_TYPES_H
