...
#ifndef MYTHERRA_COMPAT_ASSUMPTIONS_H
#define MYTHERRA_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Mytherra cannot be compiled without assertions."
#endif
...
#endif // MYTHERRA_COMPAT_ASSUMPTIONS_H
